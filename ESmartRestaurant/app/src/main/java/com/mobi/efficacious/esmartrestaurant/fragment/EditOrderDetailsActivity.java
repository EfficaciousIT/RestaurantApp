...
String pagename,FoodDescription="";
	...
	public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		...
		txtUpdate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				PostUpdate postUpdate=new PostUpdate(edtQty.getText().toString(),description_editOrder.getText().toString());
				postUpdate.execute();
			}
		});
	...
	private class PostUpdate extends AsyncTask<Void, Void, Void> {
		...
		String qtyFinal,Description;
		public PostUpdate(String toString, String toString1) {
			qtyFinal=toString;
			Description=toString1;
		}
		...
		protected Void doInBackground(Void... params) {
			...
			try
			{
				...
				request.addProperty("qty",qtyFinal );
				request.addProperty("vchFoodDescription",Description );
