...
public class KitchenActivity extends AppCompatActivity implements SearchView.OnQueryTextListener , SwipeRefreshLayout.OnRefreshListener {
	ListView listView;
	String RESTAURANTID;
						...
						if(response!=null)
						{
							...
							for(int j=0;j<str1.getPropertyCount();j++)
							{
								...
								else
								{
									...
									{
										kitchen.setVchSplitTableName(str2.getProperty("vchSplitTableName").toString().trim());
									}
									if(isValidProperty(str2, "vchSplit_status"))
									{
										kitchen.setVchSplit_status(str2.getProperty("vchSplit_status").toString().trim());
									}
