    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            ...
            case R.id.ForgotPassword_Login:
                ...
                getSupportFragmentManager().beginTransaction().replace(R.id.content_main,forgotPassword).commitAllowingStateLoss();
                break;
            case R.id.Cancel_Login:
                finish();
//                SignUpActivity signUpActivity = new SignUpActivity();
//                getSupportFragmentManager().beginTransaction().replace(R.id.content_main,signUpActivity).commitAllowingStateLoss();
                break;
            default:
                break;
        }
