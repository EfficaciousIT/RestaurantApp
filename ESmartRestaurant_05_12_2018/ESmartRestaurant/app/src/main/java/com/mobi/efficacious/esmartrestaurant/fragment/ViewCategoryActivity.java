...
import com.mobi.efficacious.esmartrestaurant.adapter.ViewCategoryAdapter;
...
public class ViewCategoryActivity extends Fragment implements SearchView.OnQueryTextListener, EditOrderDetailsActivity.EditAgeDialogListener {
	ListView gridView;
	String RESTAURANTID;
	...
	public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		myview=inflater.inflate(R.layout.viewcategory_layout,null);
		mContext=getActivity();

		settings = getActivity().getSharedPreferences(PREFRENCES_NAME,Context.MODE_PRIVATE);
		RESTAURANTID = settings.getString("TAG_RESTAURANTID", "");
		cd = new ConnectionDetector(getActivity());
		gridView = (ListView)myview.findViewById(R.id.gridView_viewcategoty);
		searchView = (SearchView)myview.findViewById(R.id.search_viewcategory);
