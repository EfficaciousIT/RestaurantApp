...
import com.mobi.efficacious.adapter.OrderAdapter;
...
public class OrderDetailsActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnSubmit = (Button)findViewById(R.id.btnSubmit_orderdetails);
		...
		if (!cd.isConnectingToInternet()) 
		 ...
		 else
		 {
			...
			{  
				...
				request.addProperty("flag", "Desktop");
				SoapSerializationEnvelope envelope = new SoapSerializationEnvelope(SoapEnvelope.VER11);
				envelope.dotNet=true;
				envelope.setOutputSoapObject(request);
		            	  ...
		            	  if(response!=null)
		  		          {
		  		        	 SoapObject str = null;
		  				        ...
		  				        {			        	
									...
									{	
										Toast.makeText(OrderDetailsActivity.this, "Order not Placed", Toast.LENGTH_LONG).show();
									}
		  				        }
		  				     }          	 
			         } 
