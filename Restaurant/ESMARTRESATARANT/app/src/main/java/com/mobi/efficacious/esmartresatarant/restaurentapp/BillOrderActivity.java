...
public class BillOrderActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mContext=BillOrderActivity.this;
		...
		listView = (ListView)findViewById(R.id.listview_billorderdetails);
		TxtAmount = (TextView)findViewById(R.id.ViewOrderTotal_billorderdetails);
		btnbill = (Button)findViewById(R.id.btnSubmittobill_billorderdetails);
		            	  ...
		            	  if(response!=null)
		  		          {
		  		        	 SoapObject str = null;
		  				        ...
		  				        {			        	
									...
									{	
										Toast.makeText(mContext, "Order Placed successfully", Toast.LENGTH_LONG).show();
									}
		  				        }
		  				      }          	 
			         } 
